...
progsfile="https://raw.githubusercontent.com/lzhecz/LARBS/master/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
putgitrepo "$dotfilesrepo" "/home/$name/stow_config" "$repobranch"
cd "home/$name/stow_config/"; stow */; cd
